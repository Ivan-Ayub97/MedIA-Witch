...
app_name   = "MedIA-Witch"
version    = "1.0"

app_name_color          = "#FF4500"  # Rojo anaranjado brillante para el nombre
background_color        = "#000000"  # Gris oscuro para el fondo
widget_background_color = "#4B0082"  # Azul más oscuro para los widgets
text_color              = "#FFFF00"  # Blanco para el text
